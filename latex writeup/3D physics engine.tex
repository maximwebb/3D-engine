...
\end{lstlisting}
\subsection{Gravity}
The strength of gravity in the universe will be set as a constant global variable, and will be added to all obloids that are not on the ground every event loop. Because the loop runs every 5 milliseconds, the gravitational constant will be different to 9.81.
\end{document}