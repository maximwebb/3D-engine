...
\newline
\newline
Instead, by using four rows and columns, the (x, y, z) offset can be represented in the fourth column as shown:
...
These are all the necessary methods required to transform 3-D space, allowing the viewer to move and look around freely. In the next section, the necessary methods for updating and drawing the universe.
\newpage

\section{Updating and Drawing the Event Loop}
